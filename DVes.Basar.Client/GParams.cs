...
namespace DVes.Basar.Client
{
    public class GParams
    {
        ...
        public IBasarCom.BasarCom BasarCom
        {
            get
            {
                if (this.m_basarCom == null)
                {
                    ...
                    this.m_basarCom.Url = string.Format("http://{0}:{1}/DVes.Basar.Integrator/IBasarCom", this.m_serverAdress, this.m_portAdress);
        ...
        public DVes.Basar.Client.IBasarCom.BizMaterialCategory GetMaterialCategoryByName(string name)
        {
            DVes.Basar.Client.IBasarCom.BizMaterialCategory[] _list = GParams.Instance.BasarCom.MaterialCategoryGetAll();
            foreach (DVes.Basar.Client.IBasarCom.BizMaterialCategory _catItem in _list)
            {
        ...
        public DVes.Basar.Client.IBasarCom.BizManufacturer GetManufacturerByName(string name)
        {
            DVes.Basar.Client.IBasarCom.BizManufacturer[] _list = GParams.Instance.BasarCom.ManufacturerGetAll();
            foreach (DVes.Basar.Client.IBasarCom.BizManufacturer _manufItem in _list)
            {
