...
using DVes.Basar.Server.Integrator;
using DVes.Basar.Data;
using System.Net;
using DVes.Basar.Server.SubForms;
...
namespace DVes.Basar.Server
{
    public partial class MainForm : Form
    {
        ...
        private void MainForm_Load(object sender, EventArgs e)
        {
            ...
            this.m_lizPb.Image = Program.OptionExist("IsActivated") ? DVes.Basar.Server.Properties.Resources.check2_32x32 : DVes.Basar.Server.Properties.Resources.delete2_32x32;
        ...
        private bool StartServiceHost(bool secureCommunication, int communicationPort, Type implementationClass, Type contract, out string errorMsg)
        {
            try
            {
                ...
                Uri _baseAddress = new Uri(protocol + Environment.MachineName + ":" + communicationPort.ToString() + "/DVes.Basar.Integrator/" + contract.Name);
        ...
        private bool StartServices(int port)
        {
            ...
            this.m_conStatePb.Image = _allStarted ? DVes.Basar.Server.Properties.Resources.check2_16x16 : DVes.Basar.Server.Properties.Resources.delete2_16x16;
