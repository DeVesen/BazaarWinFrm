...
using DVes.Basar.Server.Parameter;
...
namespace DVes.Basar.Server
{
    static class Program
    {
        ...
        static void Main()
        {
            ...
            Program.CfgFile = new DVes.Basar.Server.Parameter.CfgFile(System.IO.Path.Combine(Program.LocalAppDir, "Params.xml"));

            Program.PcCode = DVes.Basar.Data.Security.GandingSecurity.CreateBaseAccessCode();
        ...
        public static bool ActivateLizence()
        {
            ...
            Program.Activations = DVes.Basar.Data.Security.GandingSecurity.CheckLizence(Program.CfgFile.getValue_AsString("General", "License", null), Program.PcCode);
